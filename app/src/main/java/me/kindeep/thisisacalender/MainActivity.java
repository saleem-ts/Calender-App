...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toggleCalendarButton.setText("Hide Calender");
        isCalendarVisible=true;

        toggleCalendarButton.setOnClickListener(new View.OnClickListener() {
            @Override
...
//        });
    ...
    public void changeCalenderVisibility() {
       if(isCalendarVisible==true){
          ...
          toggleCalendarButton.setText("View Calender");
        }else {
           calendarView.setVisibility(View.VISIBLE);
           isCalendarVisible=true;
           toggleCalendarButton.setText("Hide Calender");
